...
dispatchCodes = {
	...
	["EmsDown"] =  {displayCode = '10-99', description = "EMS Down", radius = 15.0, recipientList = {'police', 'ambulance'}, blipSprite = 526, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "panic", offset = "false", blipflash = "false"},
